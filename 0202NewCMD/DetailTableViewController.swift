...
class DetailTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if inOrOutLabel.text == "출금" {
            inOrOutLabel.textColor = UIColor(red: 0, green: 118, blue: 186)
        } else {
            inOrOutLabel.textColor = UIColor(red: 249, green: 186, blue: 0)
        }
        if inOrOutLabel.text == "출금" {
            howMuchSpent.textColor = UIColor(red: 0, green: 118, blue: 186)
        } else {
            howMuchSpent.textColor = UIColor(red: 249, green: 186, blue: 0)
        }
    }
